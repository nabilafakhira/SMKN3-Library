...
<body>
  <div class="title">
    <p><img src="SMKN3.png" width="119" height="123" align="left">Perpustakaan </p>
    ...
    <div class="cari">
      <form name="form2" method="post" action="cari.php">
        ...
        <input name="search" type="submit" value="Search">
          ...
          <div class="form-group"><input type="text" required autocomplete="off"  class="input-mode"  placeholder="Masukan NISN/NIP*" name="nisn_nip" value=""/></div>
