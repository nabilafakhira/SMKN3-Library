...
$query_bio = mysqli_query($koneksi,"SELECT * FROM tbsiswa WHERE nisn='$_SESSION[username]'");
			...
			<h3>Data Siswa</h3>
				<table border="1" style="border-collapse: collapse; width: 100%">
					...
					<tr>
						...
						<td>&nbsp;<?php echo $rows_bio['paket_keahlian']; ?></td>
					</tr>
					<tr>
						<td>Angkatan</td>
						<td>&nbsp;<?php echo $rows_bio['angkatan']; ?></td>
					</tr>
				</table>
				<br>
				<br>
